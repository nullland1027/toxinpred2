"""
reference: pssmpro (https://github.com/deeprob/pssmpro)
"""
import re
import os
import numpy as np
...
def get_feature(pssm_dir, dataset_name, algo_type="aac_pssm", store_dir="./"):
    ...
    if store_dir:
        ...
        with open(os.path.join(store_dir, dataset_name + "_" + algo_type + ".csv"), "w") as f:
